...
GCC_ROOT=/scratch/yang/install/gcc-5.4.0
...
# NVIDIA headers
NVIDIA_HEADERS=/usr/local/apps/cuda/cuda-7.5.18/include

# Python user-site
PY_USER_SITE=/scratch/yang/env/lib/python2.7/site-packages
